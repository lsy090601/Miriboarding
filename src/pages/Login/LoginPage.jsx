...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setStoredAuth({ userId: result.user_id, userType: result.user_type, accessToken: result.access_token })
      ...
      setErrors({ password: error.message ?? '로그인 중 오류가 발생했습니다.' })
    } finally {
  ...
  return (
    <AuthLayout>
      <form className={styles.form} onSubmit={handleSubmit}>
        ...
        <button type="button" className={styles.demoLink} onClick={handleDemoLogin}>
          데모 학생 계정으로 체험하기
        </button>
      </form>
    </AuthLayout>
